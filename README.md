...
## 后续调优历程
  ...
  - 2026年6月28日——再次修复一行多公式\quad正确显示；\begin{array}{rl} ... \end{array} \quad (n) 会先转成等号对齐结构，再生成 Word 矩阵列对齐；\dagger 匕首符正确显示为 †；双重求和公式对第一个求和的空操作数补一个不可见的零宽占位字符 U+2060，防止 Word 生成占位框。
